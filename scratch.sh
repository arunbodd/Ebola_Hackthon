...
done < /localpath/2023_hackathon/scicomp-sample-workflow/results/blast/sample1_metagenomes_T1.txt

echo $valid_reads

exit

bash /localpath/2023_hackathon/scicomp-sample-workflow/bin/split_contigs.sh /localpath/2023_hackathon/scicomp-sample-workflow/results/unzip/sample4_metagenome_T1.contigs.fa "metaID" "$valid_reads"
